...
from rest.views import (
    ...
    getPorTipoProducto,
    getLotesByInvima,
    getSalidaLotesByInvima,
    getEntradaLotesByInvima,
    registrarEntradas,
    registrarSalidas,
)
...
urlpatterns = [
    ...
    path(
        "lote-entradas/", getEntradaLotesByInvima, name="product-entradaLote"
    ),
    path(
        "lote-registroEntrada/",
        registrarEntradas,
        name="product-registroEntrada",
    ),
    path(
        "lote-registroSalida/", registrarSalidas, name="product-registroSalida"
    ),
]
